...
//    }
    ...
    public void call() {
        ...
        ss.push(temp);
        memory.add3AddressCode(Operation.ASSIGN, new ImidiateAddress(temp.num, varType.Address), new Address(symbolTable.getMethodReturnAddress(className, methodName), varType.Address), null);
        memory.add3AddressCode(Operation.ASSIGN, new ImidiateAddress(memory.getCurrentCodeBlockAddress() + 2, varType.Address), new Address(symbolTable.getMethodCallerAddress(className, methodName), varType.Address), null);
